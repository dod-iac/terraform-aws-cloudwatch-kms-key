...
|------|-------------|------|---------|:--------:|
| description | The description of the key as viewed in AWS console. | `string` | `"A KMS key used to encrypt data-at-rest stored in CloudWatch Logs."` | no |
...
| name | The display name of the alias. The name must start with the word "alias" followed by a forward slash (alias/). | `string` | `"alias/cloudwatch"` | no |
